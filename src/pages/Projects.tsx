    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 p-6">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">共 {projects.length} 个项目</p>
        </div>
        ...
        {projects.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {projects.map((project) => (
              <Card
                key={project.id}
                className="overflow-hidden bg-card/50 backdrop-blur hover:shadow-lg transition-all duration-300 group"
              >
                {/* 缩略图 */}
